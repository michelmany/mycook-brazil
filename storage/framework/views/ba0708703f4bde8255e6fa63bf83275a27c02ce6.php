...
<head>
    ...
    <link href="<?php echo e(mix("/assets/css/mycook.css")); ?>" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="<?php echo e(mix('/assets/js/core/plugins.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(mix("/assets/js/painel.js")); ?>"></script>
</body>
</html>
